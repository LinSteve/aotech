	...
	<div class="inner">   
		<div class="row justify-content-center">
			...
			<?php
				if($room_id != '') {
			?>
				<form id="myForm2" action="model/rate_upd.php" method="post" class="row">
						<div class="col-lg-6">
						...
						<div class="col-lg-6">
							<div class="card shadow mb-4">
								...
								<div class="card-body ">					
										<div class="form-group">
											<label class="label-center col btn-marbot20">用電度數</label>
											<input step="0.1" min="0" max="25.5" type="number" required="required" class="form-control col-8 offset-2" name="price_elec_degree_220" value="<?php echo $price_220; ?>" required>
										</div>
								</div>
							</div>
						</div>
